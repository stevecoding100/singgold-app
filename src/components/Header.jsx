    ...
    <div className="bg-white">
      <div className="flex flex-col border-b border-gray-200 lg:border-0">
        ...
        <div className="relative">
              ...
              <div className="mx-auto max-w-2xl py-24 lg:max-w-none  lg:py-64">
                <div className="lg:pr-16">
                  <h1 className="text-4xl font-bold tracking-tight  text-gray-900 sm:text-5xl xl:text-6xl">
                    Become The{" "}
                    <span className="text-yellow-500">Professional Singer</span>{" "}
                    Of Your Dreams
                  </h1>
                  <p className="mt-4 text-xl text-gray-600">
                    Become the best singer, entrepreneur, and artist today. With
                    our dedicated and high quality courses. Get the skills you
                    need today with our certified and trainned professionals.
                  </p>
                  <div className="mt-6">
                    <a
                      href="#"
          ...
          <div className="lg:absolute lg:top-0 lg:right-0 lg:h-[90%] lg:w-[50%] md:h-full md:w-full sm:h-full sm:w-full p-8">
            <img
