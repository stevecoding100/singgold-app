            ...
            <div className="relative flex h-16 items-center justify-between">
              <div className="flex items-center px-2 lg:px-0">
                <div className="flex-shrink-0 mr-12">
                  <h1 className="block  w-auto lg:hidden font-bold text-xl">
                    Sing<span className="text-gold">Gold</span>
                  </h1>
                  <h1 className="hidden w-auto lg:block  font-bold text-xl">
                    Sing<span className="text-gold">Gold</span>
                  </h1>
                </div>
                <div className="hidden lg:ml-6 lg:block">
                  <div className="flex space-x-4">
                    ...
                    <a
                      href="#"
                      className="rounded-md bg-[#4766ff] px-3 py-2 text-sm font-medium text-white"
                    >
                      Home
                    </a>
                    <a
          ...
          <Disclosure.Panel className="lg:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              <Disclosure.Button
                as="a"
                href="#"
                className="block rounded-md bg-[#4766ff] px-3 py-2 text-base font-medium text-white"
              >
                Dashboard
              </Disclosure.Button>
              <Disclosure.Button
